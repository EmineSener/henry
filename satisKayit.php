              ...
              <div class="datatable-top">
                ...
                <div class="card-body pb-0">
                  ...
                  <table class="table table-borderless" style="height:100%" >
                    ...
                    // hangi urunden satiyor secebilmesi icin tum urunleri cekiyoruz
                    ...
                    {   
                        ...
                        echo "<form action='satisKayitFormu.php' method='POST'>";
                        
                        // urun listesi ve bir tane stais kayit buutonu yapar
                        ...
                        // bu veriler sakli halde tutluyor satisKayitFromu.php dosyasina gonderilebilmek icin
                        // hangi urunu kaydedecek id sini bilgilerini tutabilek ici
                        ...
                        echo "<td><button  type='submit' class='btn btn-primary rounded-pill' name='sil'>Satış Kaydına Git</button></td>";
                        echo "</form>";
                    }
