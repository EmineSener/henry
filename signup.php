            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation"  action="kaydet.php" method="POST"  novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="tel" class="form-control" id="yourtel" required>
                      <div class="invalid-feedback">Please enter a valid tel no!</div>
                    </div>
                    ...
                    <div class="col-12">
                      <label for="tel" class="form-label">Kullanıcı Tipi</label>
