<?php
    ...
    // sirketin basarilari kaydedilir sen yeni 3 kayit gosterilir
    ...
    $i = 0;
    // 6 tane veri cekilecek img ve bilgi
    // html icinde php script i halinde bu dizi kullanilir
    $data = array();
    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar">
            ...
            <li><a class="nav-link scrollto" href="satisKayit.php" style="color:black">Satış Kaydı Gir</a></li>
